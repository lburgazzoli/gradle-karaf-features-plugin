...
class KarafFeaturesGenPlugin implements Plugin<Project> {
    ...
    void apply(Project project) {
        ...
        KarafFeaturesGenTaskExtension extension = project.extensions.create( EXTENSION_NAME, KarafFeaturesGenTaskExtension, project )
        Task task = project.task( TASK_NAME, type: KarafFeaturesGenTask )
